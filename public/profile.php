...
<section class="section">
    <div class="container">
        ...
        <div class="profile-layout" style="display: grid; grid-template-columns: 1fr 2fr; gap: 30px;">
            ...
            <div>
                <div
                    style="background: white; padding: 30px; border-radius: 12px; box-shadow: var(--shadow); margin-bottom: 20px;">
                    <div style="text-align: center; margin-bottom: 20px;">
                        <div
                            style="width: 100px; height: 100px; background: var(--primary-color); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px; color: white; font-size: 3rem;">
                    ...
                    <div style="border-top: 1px solid var(--border-color); padding-top: 20px;">
                        <a href="<?php echo SITE_URL; ?>/public/logout.php" class="btn btn-danger"
            ...
            <div>
                <!-- Profile Info -->
                <div
                    style="background: white; padding: 30px; border-radius: 12px; box-shadow: var(--shadow); margin-bottom: 30px;">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" class="form-control" rows="3"
                                placeholder="آدرس کامل محل سکونت خود را وارد کنید"><?php echo htmlspecialchars($user['address'] ?? ''); ?></textarea>
                            <small style="color: var(--text-light);">این آدرس برای ارسال سفارشات شما استفاده
                                می‌شود</small>
                        </div>
                ...
                <div style="background: white; padding: 30px; border-radius: 12px; box-shadow: var(--shadow);">
                            ...
                            <table style="width: 100%; border-collapse: collapse;">
                                <thead>
                                    <tr style="background: var(--light-color);">
                                        <th
                                            style="padding: 12px; text-align: right; border-bottom: 2px solid var(--border-color);">
                                            شماره سفارش</th>
                                        <th
                                            style="padding: 12px; text-align: right; border-bottom: 2px solid var(--border-color);">
                                            تاریخ</th>
                    ...
                    <?php else: ?>
                        <p style="text-align: center; color: var(--text-light); padding: 40px;">هنوز سفارشی ثبت نکرده‌اید
                        </p>
                    <?php endif; ?>
                </div>
            </div>
