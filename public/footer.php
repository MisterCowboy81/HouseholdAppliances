    ...
    <div class="container">
        <div class="footer-content">
            ...
            <div class="footer-section">
                <h3>تماس با ما</h3>
                <ul>
                    <li><i class="fas fa-map-marker-alt"></i> شیراز شهر صدرا فاز یک</li>
                    <li><i class="fas fa-phone"></i> 071-32345678</li>
...
<a href="#" class="back-to-top"
    style="display: none; position: fixed; bottom: 30px; left: 30px; background: linear-gradient(135deg, var(--primary-color) 0%, var(--primary-light) 100%); color: white; width: 55px; height: 55px; text-align: center; line-height: 55px; border-radius: 50%; box-shadow: 0 8px 25px rgba(37, 99, 235, 0.4); z-index: 999; transition: all 0.3s ease; text-decoration: none;">
